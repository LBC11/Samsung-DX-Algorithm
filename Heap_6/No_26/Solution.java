...
주요 아이디어
1. DFS 가 stack, BFS 가 queue 를 이용한다면 이 문제는 priorityQueue 를 이용해서 count 가 낮은 것부터
탐색해 나가는 방식으로 해결하면 된다.
2. 큰 수부터 더하고 점점 작은 수를 더하는 거나 작은 수부터 더하고 점점 큰 수를 더하는 거나 방향만 다르지 똑같다.
3. /, % 를 이용해라
 */
